-- SecureCare seed data (insert only)
-- This assumes tables already exist

-- Enable identity insert for Advisor
...
-- Disable identity insert for Advisor
SET IDENTITY_INSERT dbo.Advisor OFF;

-- Enable identity insert for SecureCareEmployee
SET IDENTITY_INSERT dbo.SecureCareEmployee ON;
...
-- Disable identity insert for SecureCareEmployee
SET IDENTITY_INSERT dbo.SecureCareEmployee OFF;
